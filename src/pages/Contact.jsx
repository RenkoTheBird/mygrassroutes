          ...
          <div className="container mx-auto px-4 md:px-6 py-12 md:py-16">
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 md:gap-12 max-w-6xl mx-auto">
              ...
              <div className="w-full lg:w-2/5 flex items-center lg:items-start justify-center lg:justify-start">
                <h1
                  ref={contactRef}
                  className="text-6xl md:text-7xl lg:text-8xl font-extrabold text-emerald-600 fade-in-top"
                >
                  Contact
                </h1>
              </div>
              ...
              <div className="w-full lg:w-3/5">
                <div className="bg-emerald-600 text-white p-8 md:p-10 rounded-lg shadow-xl">
                  <div className="space-y-6 md:space-y-8">
                    ...
                    <div>
                      ...
                      <a 
                        ...
                        className="inline-block bg-white text-emerald-700 px-6 py-2 rounded-lg font-medium hover:bg-emerald-50 transition-colors"
                      >
                        Take Our Survey →
                      </a>
                    </div>
