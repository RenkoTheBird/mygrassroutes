                ...
                <Route
                  ...
                  <footer className="bg-gray-900 text-white py-6 text-center mt-8 px-4 md:px-6">
                    ...
                    <div className="flex items-center justify-center gap-4 mt-3">
                      ...
                      <a href="https://bsky.app/profile/mygrassroutes.com" className="text-white opacity-75 hover:text-emerald-400 hover:opacity-100 transition-colors" aria-label="Bluesky">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
                          <path d="M19.36 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.64-4.96z"/>
                        </svg>
                      </a>
                      <a href="https://discord.gg/QGwDf2PdYb" className="text-white opacity-75 hover:text-emerald-400 hover:opacity-100 transition-colors" aria-label="Discord">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
                      ...
                      <a href="https://www.reddit.com/r/mygrassroutes/" className="text-white opacity-75 hover:text-emerald-400 hover:opacity-100 transition-colors" aria-label="Reddit">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg">
